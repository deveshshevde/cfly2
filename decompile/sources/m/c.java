...
public class c {
    ...
    public static class b {
        ...
        b(b bVar) {
            this.f31051a = bVar.f31051a;
            float[] fArr = bVar.f31052b;
            this.f31052b = c.a(fArr, 0, fArr.length);
        }
        ...
        public static void a(b[] bVarArr, Path path) {
            ...
            for (int i2 = 0; i2 < bVarArr.length; i2++) {
                a(path, fArr, c2, bVarArr[i2].f31051a, bVarArr[i2].f31052b);
                c2 = bVarArr[i2].f31051a;
            }
        }
        ...
        public void a(b bVar, b bVar2, float f2) {
            ...
            while (true) {
                float[] fArr = bVar.f31052b;
                if (i2 < fArr.length) {
                    this.f31052b[i2] = (fArr[i2] * (1.0f - f2)) + (bVar2.f31052b[i2] * f2);
                    i2++;
                } else {
                    return;
                }
    ...
    private static void a(java.lang.String r8, int r9, m.c.a r10) {
        /*
            r0 = 0
            r10.f31050b = r0
            r1 = r9
        ...
        L_0x003b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: m.c.a(java.lang.String, int, m.c$a):void");
    }
    ...
    public static boolean a(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i2 = 0; i2 < bVarArr.length; i2++) {
            if (bVarArr[i2].f31051a != bVarArr2[i2].f31051a || bVarArr[i2].f31052b.length != bVarArr2[i2].f31052b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void b(b[] bVarArr, b[] bVarArr2) {
        for (int i2 = 0; i2 < bVarArr2.length; i2++) {
            bVarArr[i2].f31051a = bVarArr2[i2].f31051a;
            for (int i3 = 0; i3 < bVarArr2[i2].f31052b.length; i3++) {
                bVarArr[i2].f31052b[i3] = bVarArr2[i2].f31052b[i3];
            }
        }
    }
