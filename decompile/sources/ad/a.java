...
public final class a {
    ...
    private static final Object f45f = new Object();

    /* renamed from: g  reason: collision with root package name */
    private static a f46g;

    /* renamed from: a  reason: collision with root package name */
    private final Context f47a;

    /* renamed from: b  reason: collision with root package name */
    private final HashMap<BroadcastReceiver, ArrayList<b>> f48b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private final HashMap<String, ArrayList<b>> f49c = new HashMap<>();

    /* renamed from: d  reason: collision with root package name */
    private final ArrayList<C0003a> f50d = new ArrayList<>();
    ...
    private static final class C0003a {
        ...
        /* renamed from: b  reason: collision with root package name */
        final ArrayList<b> f54b;

        C0003a(Intent intent, ArrayList<b> arrayList) {
            this.f53a = intent;
            this.f54b = arrayList;
        }
    }
    ...
    private static final class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        final IntentFilter f55a;

        /* renamed from: b  reason: collision with root package name */
        final BroadcastReceiver f56b;
        ...
        b(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f55a = intentFilter;
            this.f56b = broadcastReceiver;
        }
    ...
    private a(Context context) {
        this.f47a = context;
        this.f51e = new Handler(context.getMainLooper()) {
    ...
    public static a a(Context context) {
        ...
        synchronized (f45f) {
            if (f46g == null) {
                f46g = new a(context.getApplicationContext());
            }
            aVar = f46g;
        }
        return aVar;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0033, code lost:
        if (r7.f58d != false) goto L_0x003e;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0035, code lost:
        r7.f56b.onReceive(r10.f47a, r4.f53a);
     */
    ...
    public void a() {
        /*
            r10 = this;
        L_0x0000:
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<ad.a$b>> r0 = r10.f48b
            monitor-enter(r0)
            java.util.ArrayList<ad.a$a> r1 = r10.f50d     // Catch:{ all -> 0x0044 }
            int r1 = r1.size()     // Catch:{ all -> 0x0044 }
            if (r1 > 0) goto L_0x000d
            monitor-exit(r0)     // Catch:{ all -> 0x0044 }
            return
        L_0x000d:
            ad.a$a[] r2 = new ad.a.C0003a[r1]     // Catch:{ all -> 0x0044 }
            java.util.ArrayList<ad.a$a> r3 = r10.f50d     // Catch:{ all -> 0x0044 }
        ...
        L_0x001c:
            if (r3 >= r1) goto L_0x0000
            r4 = r2[r3]
            java.util.ArrayList<ad.a$b> r5 = r4.f54b
            int r5 = r5.size()
            r6 = 0
        L_0x0027:
            if (r6 >= r5) goto L_0x0041
            java.util.ArrayList<ad.a$b> r7 = r4.f54b
            java.lang.Object r7 = r7.get(r6)
            ad.a$b r7 = (ad.a.b) r7
            boolean r8 = r7.f58d
            if (r8 != 0) goto L_0x003e
            android.content.BroadcastReceiver r7 = r7.f56b
            android.content.Context r8 = r10.f47a
            android.content.Intent r9 = r4.f53a
            r7.onReceive(r8, r9)
        L_0x003e:
            int r6 = r6 + 1
            goto L_0x0027
        ...
        L_0x0048:
            goto L_0x0047
        */
        throw new UnsupportedOperationException("Method not decompiled: ad.a.a():void");
    }

    public void a(BroadcastReceiver broadcastReceiver) {
        synchronized (this.f48b) {
            ArrayList remove = this.f48b.remove(broadcastReceiver);
            if (remove != null) {
                for (int size = remove.size() - 1; size >= 0; size--) {
                    b bVar = (b) remove.get(size);
                    bVar.f58d = true;
                    for (int i2 = 0; i2 < bVar.f55a.countActions(); i2++) {
                        String action = bVar.f55a.getAction(i2);
                        ArrayList arrayList = this.f49c.get(action);
                        if (arrayList != null) {
                            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                                b bVar2 = (b) arrayList.get(size2);
                                if (bVar2.f56b == broadcastReceiver) {
                                    bVar2.f58d = true;
                                    arrayList.remove(size2);
                                }
                            }
                            if (arrayList.size() <= 0) {
                                this.f49c.remove(action);
                            }
                        }
                    }
                }
    ...
    public void a(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.f48b) {
            ...
            ArrayList arrayList = this.f48b.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList(1);
                this.f48b.put(broadcastReceiver, arrayList);
            }
            arrayList.add(bVar);
            for (int i2 = 0; i2 < intentFilter.countActions(); i2++) {
                String action = intentFilter.getAction(i2);
                ArrayList arrayList2 = this.f49c.get(action);
                if (arrayList2 == null) {
                    arrayList2 = new ArrayList(1);
                    this.f49c.put(action, arrayList2);
                }
                arrayList2.add(bVar);
            }
        }
    ...
    public boolean a(android.content.Intent r22) {
        /*
            ...
            r1 = r21
            r0 = r22
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<ad.a$b>> r2 = r1.f48b
            monitor-enter(r2)
            java.lang.String r10 = r22.getAction()     // Catch:{ all -> 0x0175 }
            android.content.Context r3 = r1.f47a     // Catch:{ all -> 0x0175 }
        ...
        L_0x0056:
            java.util.HashMap<java.lang.String, java.util.ArrayList<ad.a$b>> r3 = r1.f49c     // Catch:{ all -> 0x0175 }
        ...
        L_0x0080:
            ...
            r5 = r3
            ad.a$b r5 = (ad.a.b) r5     // Catch:{ all -> 0x0175 }
            ...
            android.content.IntentFilter r9 = r5.f55a     // Catch:{ all -> 0x0175 }
            r4.append(r9)     // Catch:{ all -> 0x0175 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0175 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0175 }
        L_0x00a7:
            boolean r3 = r5.f57c     // Catch:{ all -> 0x0175 }
        ...
        L_0x00b4:
            ...
            goto L_0x0137
        L_0x00c0:
            android.content.IntentFilter r3 = r5.f55a     // Catch:{ all -> 0x0175 }
        ...
        L_0x0147:
            ...
            ad.a$b r4 = (ad.a.b) r4     // Catch:{ all -> 0x0175 }
            r5 = 0
            r4.f57c = r5     // Catch:{ all -> 0x0175 }
            int r3 = r3 + 1
            goto L_0x0147
        L_0x0159:
            java.util.ArrayList<ad.a$a> r3 = r1.f50d     // Catch:{ all -> 0x0175 }
            ad.a$a r4 = new ad.a$a     // Catch:{ all -> 0x0175 }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x0175 }
            r3.add(r4)     // Catch:{ all -> 0x0175 }
            android.os.Handler r0 = r1.f51e     // Catch:{ all -> 0x0175 }
        ...
        L_0x0179:
            goto L_0x0178
        */
        throw new UnsupportedOperationException("Method not decompiled: ad.a.a(android.content.Intent):boolean");
    }
}
