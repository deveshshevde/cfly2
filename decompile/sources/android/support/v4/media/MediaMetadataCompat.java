...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final a<String, Integer> f354a;

    /* renamed from: c  reason: collision with root package name */
    private static final String[] f355c = {"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};

    /* renamed from: d  reason: collision with root package name */
    private static final String[] f356d = {"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};

    /* renamed from: e  reason: collision with root package name */
    private static final String[] f357e = {"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
    ...
    MediaMetadataCompat(Parcel parcel) {
        this.f358b = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
