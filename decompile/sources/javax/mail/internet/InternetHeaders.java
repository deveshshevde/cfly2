...
public class InternetHeaders {
    ...
    static class matchEnum implements Enumeration {
        ...
        private Iterator f29474e;
        private boolean match;
        private String[] names;
        private InternetHeader next_header = null;
        private boolean want_line;

        matchEnum(List list, String[] strArr, boolean z2, boolean z3) {
            this.f29474e = list.iterator();
            this.names = strArr;
            this.match = z2;
            this.want_line = z3;
        }
        ...
        private InternetHeader nextMatch() {
            while (this.f29474e.hasNext()) {
                InternetHeader internetHeader = (InternetHeader) this.f29474e.next();
                if (internetHeader.line != null) {
                    if (this.names != null) {
                        ...
                        while (true) {
                            ...
                            } else if (!strArr[i2].equalsIgnoreCase(internetHeader.getName())) {
                                i2++;
                            } else if (this.match) {
                                return internetHeader;
                            }
            ...
            if (str.equalsIgnoreCase(internetHeader.getName())) {
                if (!z2) {
                    if (internetHeader.line == null || (indexOf = internetHeader.line.indexOf(58)) < 0) {
                        ...
                        str3 = String.valueOf(internetHeader.line.substring(0, indexOf + 1)) + " " + str2;
                    }
