...
public class MimeMessage extends Message implements MimePart {
    ...
    protected DataHandler f29476dh;
        ...
        for (int i3 = 0; i3 < addressArr.length; i3++) {
            ...
            while (true) {
                if (i4 >= vector.size()) {
                    z2 = false;
                    break;
                } else if (((InternetAddress) vector.elementAt(i4)).equals(addressArr[i3])) {
                    i2++;
                    addressArr[i3] = null;
                    z2 = true;
                    break;
    ...
    public synchronized DataHandler getDataHandler() throws MessagingException {
        if (this.f29476dh == null) {
            this.f29476dh = new DataHandler((DataSource) new MimePartDataSource(this));
        }
        return this.f29476dh;
    }
    ...
    public Message reply(boolean z2) throws MessagingException {
        ...
        if (z2) {
            ...
            if (eliminateDuplicates != null && eliminateDuplicates.length > 0) {
                createMimeMessage.addRecipients(z3 ? Message.RecipientType.CC : Message.RecipientType.TO, eliminateDuplicates);
            }
    ...
    public synchronized void setFlags(Flags flags2, boolean z2) throws MessagingException {
        if (z2) {
    ...
    public void updateHeaders() throws MessagingException {
        ...
        Object obj = this.cachedContent;
        if (obj != null) {
            this.f29476dh = new DataHandler(obj, getContentType());
            this.cachedContent = null;
            this.content = null;
            InputStream inputStream = this.contentStream;
            if (inputStream != null) {
