...
public abstract class Message implements Part {
    ...
    public abstract Message reply(boolean z2) throws MessagingException;
    ...
    public void setFlag(Flags.Flag flag, boolean z2) throws MessagingException {
        setFlags(new Flags(flag), z2);
    }

    public abstract void setFlags(Flags flags, boolean z2) throws MessagingException;
