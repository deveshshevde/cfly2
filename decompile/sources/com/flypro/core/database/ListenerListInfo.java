...
public class ListenerListInfo {
    ...
    public String toString() {
        return "ListenerListInfo{id=" + this.f14148id + ", name='" + this.name + '\'' + ", flying_off='" + this.flying_off + '\'' + ", fly_total_time='" + this.fly_total_time + '\'' + ", mileage=" + this.mileage + ", size=" + this.size + '}';
    }
}
