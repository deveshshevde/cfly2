...
public class BODYSTRUCTURE implements Item {
    ...
    public BODYSTRUCTURE(FetchResponse fetchResponse) throws ParsingException {
        ...
        if (fetchResponse.readByte() != 40) {
            ...
            do {
                vector.addElement(new BODYSTRUCTURE(fetchResponse2));
                fetchResponse.skipSpaces();
            ...
            this.f21758id = fetchResponse.readString();
            if (parseDebug) {
                PrintStream printStream9 = System.out;
                printStream9.println("DEBUG IMAP: id " + this.f21758id);
            }
            ...
            if (this.size >= 0) {
                if (this.type.equalsIgnoreCase("text")) {
                    ...
                    this.envelope = new ENVELOPE(fetchResponse2);
                    this.bodies = new BODYSTRUCTURE[]{new BODYSTRUCTURE(fetchResponse2)};
                    this.lines = fetchResponse.readNumber();
                    if (parseDebug) {
