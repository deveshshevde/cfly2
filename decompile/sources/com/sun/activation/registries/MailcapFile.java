...
public class MailcapFile {
    ...
    private void parse(java.io.Reader r7) throws java.io.IOException {
        ...
        L_0x0052:
            ...
            goto L_0x0006
        L_0x0068:
            r6.parseLine(r2)     // Catch:{ StringIndexOutOfBoundsException -> 0x006c }
            goto L_0x0007
        L_0x006c:
            goto L_0x0007
        */
    ...
    protected static void reportParseError(int i2, int i3, int i4, int i5, String str) throws MailcapParseException {
        if (LogSupport.isLoggable()) {
    ...
    protected static void reportParseError(int i2, int i3, int i4, String str) throws MailcapParseException {
    ...
    protected static void reportParseError(int i2, int i3, String str) throws MailcapParseException {
    ...
    public void parseLine(String str) throws MailcapParseException, IOException {
        ...
        if (i2 != 59) {
            reportParseError(59, i2, mailcapTokenizer.getCurrentTokenValue());
        }
        ...
        if (nextToken5 == 59) {
            ...
            Map map = z2 ? this.fallback_hash : this.type_hash;
