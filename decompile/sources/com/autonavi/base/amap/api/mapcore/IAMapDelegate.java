...
public interface IAMapDelegate extends IAMap {
    ...
    void changeLogoIconStyle(String str, boolean z2, int i2);

    void changeMapLogo(int i2, boolean z2);
    ...
    CameraPosition getCameraPositionPrj(boolean z2);

    Context getContext();

    a getCustomStyleManager();
    ...
    void setCustomMapStyle(boolean z2, byte[] bArr);

    void setGestureStatus(int i2, int i3);

    void setHideLogoEnble(boolean z2);
    ...
    void setMapCustomEnable(boolean z2, boolean z3);

    void setMapEnable(boolean z2);

    void setMapWidgetListener(AMapWidgetListener aMapWidgetListener);

    void setZoomPosition(int i2);

    void showCompassEnabled(boolean z2);

    void showIndoorSwitchControlsEnabled(boolean z2);
    ...
    void showLogoEnabled(boolean z2);

    void showMyLocationButtonEnabled(boolean z2);

    void showMyLocationOverlay(Location location) throws RemoteException;

    void showScaleEnabled(boolean z2);

    void showZoomControlsEnabled(boolean z2);
