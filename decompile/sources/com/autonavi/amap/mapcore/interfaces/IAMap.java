...
public interface IAMap {
    void accelerateNetworkInChinese(boolean z2);
    ...
    ArrayList<Marker> addMarkers(ArrayList<MarkerOptions> arrayList, boolean z2) throws RemoteException;
    ...
    void animateCameraWithDurationAndCallback(CameraUpdate cameraUpdate, long j2, AMap.CancelableCallback cancelableCallback) throws RemoteException;
    ...
    void clear(boolean z2) throws RemoteException;
    ...
    void set3DBuildingEnabled(boolean z2) throws RemoteException;
    ...
    void setConstructingRoadEnable(boolean z2) throws RemoteException;
    ...
    void setIndoorEnabled(boolean z2) throws RemoteException;
    ...
    void setNaviLabelEnable(boolean z2, int i2, int i3) throws RemoteException;
    ...
    void setRoadArrowEnable(boolean z2) throws RemoteException;

    void setRunLowFrame(boolean z2);

    void setTouchPoiEnable(boolean z2);
    ...
    void setZOrderOnTop(boolean z2) throws RemoteException;
