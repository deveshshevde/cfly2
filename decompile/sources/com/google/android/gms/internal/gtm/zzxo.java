...
abstract class zzxo<T, B> {
    ...
    /* access modifiers changed from: package-private */
    public abstract T zze(T t2, T t3);

    /* access modifiers changed from: package-private */
    public abstract B zzf();

    /* access modifiers changed from: package-private */
    public abstract T zzg(B b2);

    /* access modifiers changed from: package-private */
    public abstract void zzh(B b2, int i2, int i3);

    /* access modifiers changed from: package-private */
    public abstract void zzi(B b2, int i2, long j2);

    /* access modifiers changed from: package-private */
    public abstract void zzj(B b2, int i2, T t2);

    /* access modifiers changed from: package-private */
    public abstract void zzk(B b2, int i2, zztd zztd);

    /* access modifiers changed from: package-private */
    public abstract void zzl(B b2, int i2, long j2);
    ...
    /* access modifiers changed from: package-private */
    public abstract void zzo(Object obj, T t2);
    ...
    /* access modifiers changed from: package-private */
    public abstract void zzr(T t2, zztp zztp) throws IOException;

    /* access modifiers changed from: package-private */
    public abstract void zzs(T t2, zztp zztp) throws IOException;
}
