...
public final class b {
    ...
    private static volatile ClassLoader f18029a;

    /* renamed from: b  reason: collision with root package name */
    private static volatile Thread f18030b;
    ...
    private static synchronized ClassLoader b() {
        synchronized (b.class) {
            ...
            synchronized (f18030b) {
                try {
                    classLoader = f18030b.getContextClassLoader();
    ...
    private static synchronized java.lang.Thread c() {
        /*
        ...
        L_0x00a3:
            goto L_0x00a2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.dynamite.b.c():java.lang.Thread");
    }
}
