...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(Gson gson, Field field, String str, TypeToken<?> typeToken, boolean z2, boolean z3) {
        ...
        return new BoundField(str, z2, z3) {
            /* access modifiers changed from: package-private */
            ...
            public void write(JsonWriter jsonWriter, Object obj) throws IOException, IllegalAccessException {
                (z4 ? typeAdapter2 : new TypeAdapterRuntimeTypeWrapper(gson3, typeAdapter2, typeToken3.getType())).write(jsonWriter, field3.get(obj));
            }
    ...
    static boolean excludeField(Field field, boolean z2, Excluder excluder2) {
        return !excluder2.excludeClass(field.getType(), z2) && !excluder2.excludeField(field, z2);
    }
            ...
            while (i2 < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    while (i3 < size) {
                        ...
                        Field field2 = field;
                        boundField = boundField2 == null ? (BoundField) linkedHashMap.put(str2, createBoundField(gson, field, str2, TypeToken.get(resolve), z3, excludeField2)) : boundField2;
                        i3 = i4 + 1;
                        excludeField = z3;
                        fieldNames = list;
                        size = i5;
