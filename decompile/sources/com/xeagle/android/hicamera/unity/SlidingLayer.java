...
public class SlidingLayer extends FrameLayout {
    ...
    private static final Interpolator f23672e = new Interpolator() {
    ...
    protected int f23673a;

    /* renamed from: b  reason: collision with root package name */
    protected VelocityTracker f23674b;

    /* renamed from: c  reason: collision with root package name */
    protected int f23675c;

    /* renamed from: d  reason: collision with root package name */
    protected Bundle f23676d;

    /* renamed from: f  reason: collision with root package name */
    private Random f23677f;

    /* renamed from: g  reason: collision with root package name */
    private Scroller f23678g;

    /* renamed from: h  reason: collision with root package name */
    private int f23679h;

    /* renamed from: i  reason: collision with root package name */
    private Drawable f23680i;

    /* renamed from: j  reason: collision with root package name */
    private boolean f23681j;
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public SavedState(Parcel parcel) {
            super(parcel);
            this.f23698a = parcel.readBundle();
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeBundle(this.f23698a);
        }
    }
    ...
    public SlidingLayer(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f23685n = obtainStyledAttributes.getBoolean(0, true);
        this.f23686o = obtainStyledAttributes.getBoolean(2, true);
    ...
    private void a(MotionEvent motionEvent) {
        ...
        if (l.b(motionEvent, b2) == this.f23673a) {
            int i2 = b2 == 0 ? 1 : 0;
            this.f23692u = l.c(motionEvent, i2);
            this.f23673a = l.b(motionEvent, i2);
            VelocityTracker velocityTracker = this.f23674b;
    ...
    private void a(boolean z2, boolean z3, boolean z4, int i2, int i3) {
        if (z4 || z2 != this.f23696y) {
            ...
            this.f23696y = z2;
            float width = this.f23692u - ((float) (getWidth() / 2));
            float height = this.f23693v - ((float) (getHeight() / 2));
            boolean z5 = this.f23684m == -3 && Math.abs(i2) < this.B && Math.abs(i3) < this.B;
    ...
    private boolean a(float f2, float f3) {
        int i2;
        if ((this.f23696y && ((float) getLeft()) <= f3) || ((float) getRight()) >= f3) {
            int i3 = this.f23684m;
            if (i3 == -3) {
                return f2 != 0.0f;
            }
        ...
        if (!this.f23696y && (i2 = this.f23682k) > 0 && f2 > 0.0f) {
            int i4 = this.f23684m;
            return i4 != -3 ? i4 != -2 ? i4 == -1 && f3 >= ((float) (getWidth() - this.f23682k)) && f2 < 0.0f : f3 <= ((float) i2) && f2 > 0.0f : f2 != 0.0f;
        }
        return false;
    }
    ...
    private boolean a(MotionEvent motionEvent, float f2) {
        ...
        boolean z2 = this.f23696y;
        if (z2) {
            return true;
        }
        if (z2 || (i2 = this.f23682k) <= 0) {
            return false;
        }
        return i3 != -2 ? i3 == -1 && f2 >= ((float) (getWidth() - this.f23682k)) : f2 <= ((float) i2);
    }
    ...
    private boolean a(boolean r9, float r10, float r11, int r12, int r13, int r14, int r15) {
        ...
        L_0x00a6:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xeagle.android.hicamera.unity.SlidingLayer.a(boolean, float, float, int, int, int, int):boolean");
    }
    ...
    private void b() {
        ...
        this.f23678g = new Scroller(context, f23672e);
        ViewConfiguration viewConfiguration = ViewConfiguration.get(context);
        this.f23691t = ad.a(viewConfiguration);
        this.B = viewConfiguration.getScaledMinimumFlingVelocity();
        this.f23675c = viewConfiguration.getScaledMaximumFlingVelocity();
        this.C = (int) (context.getResources().getDisplayMetrics().density * 25.0f);
        this.f23677f = new Random();
    }
    ...
    private boolean b(float f2, float f3) {
        int i2;
        if ((this.f23696y && ((float) getTop()) <= f3) || ((float) getBottom()) >= f3) {
            int i3 = this.f23684m;
            if (i3 == -5) {
                return this.f23696y && f2 > 0.0f;
            }
            if (i3 == -4) {
                return this.f23696y && f2 < 0.0f;
            }
        ...
        if (!this.f23696y && (i2 = this.f23682k) > 0 && f2 > 0.0f) {
            int i4 = this.f23684m;
            return i4 != -5 ? i4 != -4 ? i4 == -3 && f2 != 0.0f : f3 <= ((float) i2) && f2 > 0.0f : f3 >= ((float) (getHeight() - this.f23682k)) && f2 < 0.0f;
        }
        return false;
    }
    ...
    private boolean b(MotionEvent motionEvent, float f2) {
        ...
        return i3 != -5 ? i3 == -4 && f2 <= ((float) i2) : f2 >= ((float) (getHeight() - this.f23682k));
    }
    ...
    private int[] b(int r13, int r14) {
        ...
        L_0x0034:
            ...
            java.util.Random r3 = r12.f23677f
        ...
        L_0x00e6:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xeagle.android.hicamera.unity.SlidingLayer.b(int, int):int[]");
    }
    ...
    private void d() {
        if (this.f23697z) {
            setDrawingCacheEnabled(false);
            this.f23678g.abortAnimation();
            int scrollX = getScrollX();
            int scrollY = getScrollY();
            int currX = this.f23678g.getCurrX();
            int currY = this.f23678g.getCurrY();
    ...
    public void a(int i2, int i3, int i4) {
        ...
        int abs = Math.abs(i4);
        this.f23678g.startScroll(scrollX, scrollY, i5, i6, Math.min(abs > 0 ? Math.round(Math.abs(a2 / ((float) abs)) * 1000.0f) * 4 : 600, 600));
        invalidate();
    }
    ...
    public void computeScroll() {
        if (this.f23678g.isFinished() || !this.f23678g.computeScrollOffset()) {
            d();
            return;
        }
        int scrollX = getScrollX();
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        int i2 = this.f23679h;
        if (i2 > 0 && (drawable = this.f23680i) != null) {
            if (this.f23684m == -1) {
                drawable.setBounds(0, 0, i2, getHeight());
            }
            if (this.f23684m == -4) {
                this.f23680i.setBounds(0, getHeight() - this.f23679h, getWidth(), getHeight());
            }
            if (this.f23684m == -2) {
                this.f23680i.setBounds(getWidth() - this.f23679h, 0, getWidth(), getHeight());
            }
            if (this.f23684m == -5) {
                this.f23680i.setBounds(0, 0, getWidth(), this.f23679h);
            }
            this.f23680i.draw(canvas);
        }
    }
    ...
    public void drawableStateChanged() {
        ...
        Drawable drawable = this.f23680i;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            this.f23694w = c2;
            this.f23692u = c2;
            float d2 = l.d(motionEvent, this.f23673a);
            this.f23695x = d2;
            this.f23693v = d2;
            if (!a(motionEvent, this.f23694w) && !b(motionEvent, this.f23695x)) {
                this.f23690s = true;
            } else {
                this.f23689r = false;
                this.f23690s = false;
            ...
            if (i4 != -1) {
                ...
                if (a2 == -1) {
                    ...
                    float f2 = c3 - this.f23692u;
                    float abs = Math.abs(f2);
                    float d3 = l.d(motionEvent, a2);
                    float f3 = this.f23693v;
                    float f4 = d3 - f3;
                    float abs2 = Math.abs(d3 - f3);
                    if (abs > ((float) this.f23691t) && abs > abs2 && a(f2, this.f23694w)) {
                        this.f23692u = c3;
                    } else if (abs2 > ((float) this.f23691t) && abs2 > abs && b(f4, this.f23695x)) {
                        this.f23693v = d3;
                    }
                    setDrawingCacheEnabled(true);
                }
        ...
        if (!this.f23689r) {
            if (this.f23674b == null) {
                this.f23674b = VelocityTracker.obtain();
            }
            this.f23674b.addMovement(motionEvent);
        }
        return this.f23689r;
    }
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (i6 != this.f23684m || this.f23681j) {
            this.f23681j = false;
            this.f23684m = i6;
            if (!this.f23696y) {
                b(false, true);
            ...
            int i7 = this.f23684m;
            if (i7 == -1) {
                paddingLeft2 = getPaddingLeft() + this.f23679h;
                paddingTop = getPaddingTop();
            } else if (i7 == -5) {
                paddingLeft2 = getPaddingLeft();
                paddingTop = getPaddingTop() + this.f23679h;
            } else {
                if (i7 == -2) {
                    ...
                    paddingBottom = getPaddingBottom() + this.f23679h;
                    setPadding(paddingLeft2, paddingTop, paddingRight, paddingBottom);
                } else if (i7 == -3) {
                    paddingLeft = getPaddingLeft() + this.f23679h;
                }
                paddingTop = getPaddingTop();
                paddingRight = getPaddingRight() + this.f23679h;
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        a((Parcelable) savedState.f23698a);
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (this.f23676d == null) {
            this.f23676d = new Bundle();
        }
        this.f23676d.putBoolean("is_open", a());
        savedState.f23698a = this.f23676d;
        return savedState;
    }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r14) {
        /*
            r13 = this;
            boolean r0 = r13.f23687p
            r1 = 0
            if (r0 == 0) goto L_0x0140
            boolean r0 = r13.f23689r
            if (r0 != 0) goto L_0x001f
            boolean r0 = r13.D
            if (r0 != 0) goto L_0x001f
            float r0 = r13.f23694w
            boolean r0 = r13.a((android.view.MotionEvent) r14, (float) r0)
            if (r0 != 0) goto L_0x001f
            float r0 = r13.f23695x
        ...
        L_0x0030:
            r13.D = r1
        L_0x0032:
            android.view.VelocityTracker r4 = r13.f23674b
        ...
        L_0x0072:
            ...
            goto L_0x0137
        L_0x0088:
            boolean r14 = r13.f23689r
            if (r14 == 0) goto L_0x0139
            boolean r14 = r13.f23696y
        ...
        L_0x00a3:
            float r2 = t.l.c(r14, r0)
            float r5 = r13.f23692u
            float r2 = r2 - r5
            java.lang.Math.abs(r2)
            float r14 = t.l.d(r14, r0)
            float r0 = r13.f23693v
            float r14 = r14 - r0
        ...
        L_0x00b9:
            ...
            android.view.VelocityTracker r0 = r13.f23674b
            ...
            float r7 = r13.f23694w
            float r8 = r8 - r7
            int r11 = (int) r8
            float r7 = r13.f23695x
            float r14 = r14 - r7
            int r12 = (int) r14
            boolean r14 = r13.f23696y
            float r7 = (float) r5
        ...
        L_0x010a:
            ...
            boolean r0 = r13.f23685n
            if (r0 == 0) goto L_0x0116
            r13.b((boolean) r3)
            goto L_0x0139
        L_0x0116:
            if (r14 != 0) goto L_0x0139
            boolean r14 = r13.f23686o
            if (r14 == 0) goto L_0x0139
            r13.a((boolean) r3)
            goto L_0x0139
        L_0x0120:
    ...
    public boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.f23680i;
    }
}
