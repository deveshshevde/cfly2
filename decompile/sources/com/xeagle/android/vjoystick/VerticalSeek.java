...
public class VerticalSeek extends SeekBar {
    ...
    public VerticalSeek(Context context, AttributeSet attributeSet, int i2) {
        super(context, attributeSet, i2);
        this.f24937d = ViewConfiguration.get(context).getScaledTouchSlop();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x002d, code lost:
        if (java.lang.Math.abs(r5.getY() - r4.f24936c) > ((float) r4.f24937d)) goto L_0x0063;
     */
    ...
    public boolean onTouchEvent(android.view.MotionEvent r5) {
        ...
        L_0x007d:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xeagle.android.vjoystick.VerticalSeek.onTouchEvent(android.view.MotionEvent):boolean");
    }
