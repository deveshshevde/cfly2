...
public class ListenerInfoBeans {
    ...
    public String toString() {
        return "ListenerInfoBeans{id=" + this.f23796id + ", name='" + this.name + '\'' + ", flying_off='" + this.flying_off + '\'' + ", fly_total_time='" + this.fly_total_time + '\'' + ", mileage=" + this.mileage + ", size=" + this.size + '}';
    }
}
