...
public final class IntentUtils {
    ...
    public static Intent getComponentIntent(String str, String str2, boolean z2) {
        return getComponentIntent(str, str2, (Bundle) null, z2);
    }
    ...
    private static Intent getIntent(Intent intent, boolean z2) {
        return z2 ? intent.addFlags(AMapEngineUtils.MAX_P20_WIDTH) : intent;
    }
    ...
    public static Intent getShareTextImageIntent(String str, LinkedList<String> linkedList) {
        ...
        if (linkedList != null) {
            ...
            while (it2.hasNext()) {
                File fileByPath = UtilsBridge.getFileByPath((String) it2.next());
                if (fileByPath != null) {
    ...
    public static Intent getShareTextImageIntent(String str, List<File> list) {
        ArrayList arrayList = new ArrayList();
        if (list != null) {
            for (File file2Uri : list) {
                Uri file2Uri2 = UtilsBridge.file2Uri(file2Uri);
                if (file2Uri2 != null) {
                    arrayList.add(file2Uri2);
                }
            }
        }
