...
public class v {
    ...
    /* renamed from: ao.v$1  reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static final /* synthetic */ int[] f5547c;

        /* renamed from: d  reason: collision with root package name */
        static final /* synthetic */ int[] f5548d;
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f5548d     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x0043:
                r3 = 4
                int[] r4 = f5547c     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                r4 = 5
                int[] r5 = f5547c     // Catch:{ NoSuchFieldError -> 0x0059 }
            ...
            L_0x006a:
                int[] r5 = f5546b     // Catch:{ NoSuchFieldError -> 0x0074 }
            ...
            L_0x0085:
                int[] r1 = f5545a     // Catch:{ NoSuchFieldError -> 0x008f }
            ...
            L_0x008f:
                int[] r0 = f5545a     // Catch:{ NoSuchFieldError -> 0x0099 }
            ...
            L_0x0099:
                int[] r0 = f5545a     // Catch:{ NoSuchFieldError -> 0x00a3 }
            ...
            L_0x00a3:
                int[] r0 = f5545a     // Catch:{ NoSuchFieldError -> 0x00ad }
            ...
            L_0x00ad:
                int[] r0 = f5545a     // Catch:{ NoSuchFieldError -> 0x00b8 }
            ...
            L_0x00b8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: ao.v.AnonymousClass1.<clinit>():void");
        }
    }

    public static int a(BackoffPolicy backoffPolicy) {
        int i2 = AnonymousClass1.f5546b[backoffPolicy.ordinal()];
        if (i2 == 1) {
            return 0;
        }
        if (i2 == 2) {
    ...
    public static int a(NetworkType networkType) {
        int i2 = AnonymousClass1.f5547c[networkType.ordinal()];
        if (i2 == 1) {
            return 0;
        }
        if (i2 == 2) {
    ...
    public static int a(OutOfQuotaPolicy outOfQuotaPolicy) {
        int i2 = AnonymousClass1.f5548d[outOfQuotaPolicy.ordinal()];
        if (i2 == 1) {
            return 0;
        }
        if (i2 == 2) {
    ...
    public static int a(WorkInfo.State state) {
        switch (AnonymousClass1.f5545a[state.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
    ...
    public static WorkInfo.State a(int i2) {
        if (i2 == 0) {
    ...
    public static androidx.work.c a(byte[] r6) {
        ...
        L_0x006c:
            goto L_0x006b
        */
        throw new UnsupportedOperationException("Method not decompiled: ao.v.a(byte[]):androidx.work.c");
    }
    ...
    public static byte[] a(androidx.work.c r4) {
        ...
        L_0x0008:
            ...
            int r1 = r4.b()     // Catch:{ IOException -> 0x004f, all -> 0x004c }
            r2.writeInt(r1)     // Catch:{ IOException -> 0x004f, all -> 0x004c }
            java.util.Set r4 = r4.a()     // Catch:{ IOException -> 0x004f, all -> 0x004c }
        ...
        L_0x0021:
            ...
            androidx.work.c$a r1 = (androidx.work.c.a) r1     // Catch:{ IOException -> 0x004f, all -> 0x004c }
        ...
        L_0x0083:
            goto L_0x0082
        */
        throw new UnsupportedOperationException("Method not decompiled: ao.v.a(androidx.work.c):byte[]");
    }
