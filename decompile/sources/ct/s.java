...
public class s extends d {
    ...
    public void a() {
        super.a();
        int i2 = 0;
        GLES20.glDeleteTextures(1, this.f26418b, 0);
        while (true) {
            int[] iArr = this.f26418b;
            if (i2 < iArr.length) {
                iArr[i2] = -1;
                i2++;
            } else {
    ...
    public void c() {
        ...
        while (true) {
            ...
            if (i2 < iArr.length && iArr[i2] != -1) {
                ...
                GLES20.glBindTexture(3553, this.f26418b[i2]);
                GLES20.glUniform1i(this.f26419c[i2], i3);
                i2++;
            } else {
                return;
            }
    ...
    public void e() {
        ...
        a((Runnable) new Runnable() {
            public void run() {
                s.this.f26418b[0] = a.a(b.f10869a, "filter/kelvinmap.png");
            }
        });
    }
}
