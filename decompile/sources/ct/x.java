...
public class x extends d {
    ...
    public void a() {
        super.a();
        int i2 = 0;
        GLES20.glDeleteTextures(1, this.f26434b, 0);
        while (true) {
    ...
    public void c() {
        ...
        while (true) {
            ...
            if (i2 < iArr.length && iArr[i2] != -1) {
                ...
                GLES20.glBindTexture(3553, this.f26434b[i2]);
                GLES20.glUniform1i(this.f26435c[i2], i3);
                i2++;
            } else {
                return;
            }
    ...
    public void e() {
        ...
        a((Runnable) new Runnable() {
            public void run() {
                x.this.f26434b[0] = a.a(b.f10869a, "filter/nashvillemap.png");
            }
        });
    }
}
