...
public class IjkMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public String getBitrateInline() {
            ...
            if (i2 < 0) {
                objArr[0] = Long.valueOf(this.mBitrate);
                return String.format(locale, "%d bit/s", objArr);
            }
            objArr[0] = Long.valueOf(this.mBitrate / 1000);
        ...
        public java.lang.String getFpsInline() {
            ...
            L_0x0011:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: tv.danmaku.ijk.media.player.IjkMediaMeta.IjkStreamMeta.getFpsInline():java.lang.String");
        }
    ...
    public String getDurationInline() {
        ...
        long j3 = j2 / 60;
        return String.format(Locale.US, "%02d:%02d:%02d", new Object[]{Long.valueOf(j3 / 60), Long.valueOf(j3 % 60), Long.valueOf(j2 % 60)});
    }
